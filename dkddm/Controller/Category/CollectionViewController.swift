...
class CollectionViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
    ...
    fileprivate lazy var collectionView : UICollectionView = {
        ...
        collectionView.register(CollectionViewHeaderView.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: kCollectionViewHeaderView)
...
extension CollectionViewController {
    ...
    func configureData() {
        ...
        guard let path = Bundle.main.path(forResource: "categorydata", ofType: "json") else { return }
...
extension CollectionViewController {
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        let view = collectionView.dequeueReusableSupplementaryView(ofKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: reuseIdentifier!, for: indexPath) as! CollectionViewHeaderView
